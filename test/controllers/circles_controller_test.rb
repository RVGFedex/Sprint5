...
class CirclesControllerTest < ActionController::TestCase
  ...
  test "should create circle" do
    assert_difference('Circle.count') do
      post :create, circle: { group_code: @circle.group_code, name: @circle.name, points: @circle.points, status: @circle.status }
    end
  ...
  test "should update circle" do
    patch :update, id: @circle, circle: { group_code: @circle.group_code, name: @circle.name, points: @circle.points, status: @circle.status }
    assert_redirected_to circle_path(assigns(:circle))
  end
